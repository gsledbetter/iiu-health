...
This project explores the features and functionality of Apple's HealthKit and ResearchKit. 

## Goals
To create a working example of how to use Apple's ResearchKit and HealthKit.
